...
public class MainServer {
    public static Hashtable<ChannelId, SocketInfo> HT_ConnectedAllUserInfo = new Hashtable<ChannelId, SocketInfo>();
    public static Hashtable<Integer, GameRoomInfo> roomList = new Hashtable<Integer, GameRoomInfo>();
    public static int RoomNumber = 100;
    public static int IDCode = 1;
	...
	*/
        ...
        try{
            ...
            sb.group(parentGroup, childGroup)
                    ...
                    .childHandler(new ServerChannelInitalizer());


            // 인커밍 커넥션을 액세스하기 위해 바인드하고 시작합니다.
            ChannelFuture cf = sb.bind(Integer.parseInt(props.port)).sync();
